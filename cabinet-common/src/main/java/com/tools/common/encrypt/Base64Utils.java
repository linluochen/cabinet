...
public class Base64Utils {
    ...
    public static String encodeObject(java.io.Serializable serializableObject, boolean breakLines) {
        ...
        try {
            ...
            b64os = new OutputStream(baos, Base64Utils.ENCODE, breakLines);
    ...
    /**
     * Encodes a string in Base64Utils notation with line breaks
     * after every 75 Base64Utils characters.
    ...
    /**
     * Simple helper method that Base64Utils-encodes a file
    ...
    /**
     * Simple helper method that Base64Utils-decodes a file
    ...
    /**
     * Simple helper method that Base64Utils-encodes data to a file.
     *
    ...
    /**
     * Simple helper method that Base64Utils-decodes data to a file.
     *
     ...
     * decoded values.
     *
     * @param fourBytes the array with Base64Utils content
    ...
    /**
     * Decodes data from Base64Utils notation.
     *
    ...
    /**
     * Decodes data from Base64Utils notation and
    ...
    /**
     * Decodes Base64Utils content in byte array format and returns
    ...
    public static byte[] decode(byte[] source, int off, int len) {
        ...
        for (i = off; i < off + len; i++) {
            ...
            if (sbiDecode >= WHITE_SPACE_ENC) // White space, Equals sign or better
            {
                ...
                System.err.println("Bad Base64Utils input character at " + i + ": " + source[i] + "(decimal)");
                return null;
            }   // end else:
        ...
        public InputStream(java.io.InputStream in, boolean encode, boolean breakLines) {
            ...
            try {
                if (encode) {
                    ...
                    intAvailable = (len43) + ((in.available() % 3) > 0 ? 4 : 0) + (breakLines ? (len43 / MAX_LINE_LENGTH) : 0);
                } else {
                    intAvailable = in.available() * 3 / 4;
                }
            } catch (Exception e) {
            }
    ...
    public static class OutputStream extends java.io.FilterOutputStream {
        ...
        public void write(int theByte) throws java.io.IOException {
            if (encode) {
                ...
                {
                    out.write(Base64Utils.encode3to4(buffer, bufferLength));
            ...
            // Else, Decoding
                ...
                if (DECODABET[theByte & 0x7f] > WHITE_SPACE_ENC) {
                    ...
                    {
                        out.write(Base64Utils.decode4to3(buffer));
                        position = 0;
                    }   // end if: enough to output
        ...
        /**
         * Appropriately pads Base64Utils notation when encoding
         * or throws an exception if Base64Utils input is not
        ...
        public void flush() throws java.io.IOException {
            ...
            if (position > 0) {
                if (encode) {
                    out.write(Base64Utils.encode3to4(buffer, position));
                    position = 0;
                }   // end if: encoding
                else {
