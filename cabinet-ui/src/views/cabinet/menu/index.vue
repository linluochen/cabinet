<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="menuList" @selection-change="handleSelectionChange">
      ...
      <el-table-column align="center" label="标题名称" prop="title"/>
      <el-table-column align="center" label="描述" prop="describe"/>
      <el-table-column align="center" label="备注" prop="remark" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.remark, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" append-to-body width="500px">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="备注" prop="remark">
          <el-date-picker v-model="form.remark"
                          clearable
                          placeholder="请选择备注"
                          type="date"
...
<script>
import {addMenu, delMenu, getMenu, listMenu, updateMenu} from "@/api/cabinet/menu";
